                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-data-feature" style="justify-content: flex-start">
                                    ...
                                    <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->avoir_id}}"
                                        name="factid"
                                        href='/extrasAvoir?idFacture={{$fact->avoir_id}}&&idClient={{$c->client_id}}'
                                    ...
                                    <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->avoir_id}}"
                                        name="factid"
                                        href='/code_edit_av?idFacture={{$fact->avoir_id}}&&idClient={{$c->client_id}}'
                                        class="btn btn-xs btn-info pull-right">
                                    ...
                                    <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->avoir_id}}"
                                        name="factid"
                                        href='/code_delete_av?idFacture={{$fact->avoir_id}}&&idClient={{$c->client_id}}'
                                        class="btn btn-xs btn-info pull-right">
