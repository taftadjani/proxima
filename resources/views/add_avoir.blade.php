        ...
        <div class="card m-b-10" style="width: 100%">
            <div class="card-body">
                ...
                <div class="row" style="margin-bottom: 30px;">
                    ...
                    <div class="col-lg-6">
                        <label>Numéro</label>
                        <input id="numero" name="numero" class="form-control" type="text" value="A-{{$y}}-{{$idFact+1}}"
                            readOnly>
                    </div>
                </div>
                        ...
                        <div class="form-group"><label>Date Echéance</label>
                            <div>
                                <div class="input-group"><input name="date_validite" type="text" class="form-control"
                                        placeholder="yyyy-mm-dd" id="datepicker-multiple-date">
                                    <div class="input-group-append bg-custom b-0"><span class="input-group-text"><i
                                                class="mdi mdi-calendar"></i></span></div>
                                </div>
                                <!-- input-group -->
                    ...
                    <div class="col-lg-6">
                        <div class="form-group"><label>Remboursement</label>
                            <div>
                                ...
                                <div class="col">
                                    <input id="date_remb" name="date_remb" class="form-control" type="text"
                                        value="{{$today}}" readOnly>
                                </div>
                                <!-- input-group -->
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col">
                            <input class="form-control" id="remiseTotal" name="remiseTotal" type="text"
                                onkeypress="javascript:NumOnly(this.value)" onpaste="javascript:return false" value="0"
                                required>
                        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="qte" name="qte" class="form-control" type="text"
                                    ...
                                    onkeyup="javascript:calculHt(0)" required>
                            </td>
                            <td>
                                <input id="remise" name="remise" class="form-control" type="text"
                                    onkeypress="javascript:NumOnly(this.value)" onpaste="javascript:return false"
                                    onkeyup="javascript:calculRemise(0)" required>
                            </td>
                            <td>
