...
class FactureController extends Controller
{
    ...
    public function ajout_factures()
    {
        ...
        $idFact = DB::table('factures')
                   ->max('facture_id');
        return view("add_facture",['clients'=>$clients,'tarifs'=>$tarifs,'condition'=>$condition,'produits'=>$produits,'idFact'=>$idFact]);
    }
    ...
    public function liste_factures()
    {
        ...
        return view("list_facture",['factures'=>$factures]);
    }
    ...
    public function verif_edit(Request $request)
    {
        ...
        $produits = DB::table('produits')
                   ->get();
           return view('modify_facture',['facture'=>$fact,'clients'=>$clients,'tarifs'=>$tarifs,'condition'=>$condition,'produits'=>$produits]);
    ...
    public function create(Request $request )
    {
        ...
        $qteStockp=DB::table('produits')
            ...
            foreach($qteStockp as $qt){
                ...
                if($qt<$qte){
                    return redirect()->route('add_facture');
                }
                else
                $nv_qtep=$qt-$qte;
