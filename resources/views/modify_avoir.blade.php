...
<form id="form" action="{{ url('/modif_avoir') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="table-wrapper">
        <div class="card m-b-10" style="width: 100%">
            <div class="card-body">
                <input name="idfacture" id="idfacture" class="form-control" type="text" value="{{$fact->avoir_id}}"
                    hidden readOnly />
                        ...
                        <div class="form-group"><label>Date Echéance</label>
                            <div>
                                <div class="input-group"><input name="date_validite" type="text" class="form-control"
                                        value="{{$fact->date_echeance}}" id="datepicker-multiple-date">
                                    <div class="input-group-append bg-custom b-0"><span class="input-group-text"><i
                                                class="mdi mdi-calendar"></i></span></div>
                                </div>
                                <!-- input-group -->
                            ...
                            <div>
                                <div class="input-group">
                                    <input id="remb" name="remb" class="form-control" type="text"
                                        value='{{$fact->remboursement}}'>

                                    <div class="input-group-append bg-custom b-0"></div>
                                </div>
                                <div class="col">
                                    <input id="date_remb" name="date_remb" class="form-control" type="text"
                                        value="{{$fact->date_remboursement}}" readOnly>
                                </div>
                                <!-- input-group -->
                            </div>
                        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input class="form-control" id="id_prod_fact{{$j}}" name="id_prod_fact{{$j}}"
                                    type="text" value="{{$pf->avoir_produit_id}}" hidden>
