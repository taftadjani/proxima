                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-data-feature" style="justify-content: flex-start">
                                    ...
                                    <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->devis_id}}"
                                        name="factid"
                                        href='/extrasDevis?idFacture={{$fact->devis_id}}&&idClient={{$c->client_id}}'
                                    ...
                                    <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->devis_id}}"
                                        name="factid"
                                        href='/code_edit_devis?idFacture={{$fact->devis_id}}&&idClient={{$c->client_id}}'
                                        class="btn btn-xs btn-info pull-right">
                                    ...
                                    <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->devis_id}}"
                                        name="factid"
                                        href='/code_delete_devis?idFacture={{$fact->devis_id}}&&idClient={{$c->client_id}}'
                                        class="btn btn-xs btn-info pull-right">
